...
@section('content')
    <section class="px-6 py-8 ">
        ...
        <main class="max-w-6xl mx-auto mt-10 lg:mt-20 space-y-6  pt-8">
            ...
            <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
                ...
                <div class="col-span-8">
                    <div class="hidden lg:flex justify-between mb-6">
                        <a href="/"
                            class="transition-colors duration-300 relative inline-flex justify-content-end items-center text-lg hover:text-blue-500">
